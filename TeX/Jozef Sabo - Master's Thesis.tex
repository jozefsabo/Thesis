...
\title{Image deblurring using two images with different exposure times}   % tyto dvě položky jsou zde v podstatě formálně, ve skutečnosti nejsou nikde
...
\begin{figure}[h]
  \centering
	  ...
	  \subfloat[]{\label{fig:iso_castle256_blurkernel10}\includegraphics[width=0.5\textwidth]{iso_castle256_blurkernel10.png}}
